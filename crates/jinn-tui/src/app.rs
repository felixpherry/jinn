...
pub fn scope_for_focus(focus: &jinn_domain::FocusScope) -> Scope {
    match focus {
        FocusScope::Picker { kind } => match kind {
            ...
            PickerKind::AuthLogin => Scope::PickerAuthLogin,
            PickerKind::AuthMethod => Scope::PickerAuthMethod,
            PickerKind::AuthProgress => Scope::PickerAuthProgress,
            PickerKind::AuthLogout => Scope::PickerAuthLogout,
        },
